...
var BaseLinter = (function () {
    ...
    BaseLinter.prototype.handleError = function (expectedFileName, fileName, error) {
        var customError = "Linting with " + this.Id + " failed. Please install the linter or turn it off.\n";
        ...
        vscode_1.window.showInformationMessage(customError + ". View Python output for details.");
    };
    return BaseLinter;
}());
